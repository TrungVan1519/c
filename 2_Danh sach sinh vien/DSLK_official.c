...
int main()
{
    /// 2 loi thuong gap trong danh sach lien ket do la:
    /// #1: Hay quen ham Create_Tlist() ----> K chay dc chuong trinh
    /// #2: O ham Add_Name va Check_Del hay quen temp = temp -> pNext va del = del ->pNext ----> chuong trinh k bao loi nhung k them vs xoa dc
    Create_MENU();
    return 0;
}
